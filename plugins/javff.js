...
TOP UP? GAS TERUSS`;
  ...
  m.reply(`*「 PESANAN SEDANG DI PROSES 」*`);
   let res = await fetch(
    `https://v1.apigames.id/transaksi/http-get-v1?merchant=M220511FSMZ8818TO&secret=92b49f13e5d556ce5c2738a8d7163f4f699052c5859f8f3f833531a32acaca19&produk=ff${num}&tujuan=${id}&ref=JAVAN-${makeid(6)}`);
